...
for each row when (now() > '2018-03-11 12:00') execute procedure count_requests(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_commits(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_branches(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_pull_requests(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_tags(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_builds(1);
...
-- for each row when (now() > '2018-03-11 12:00') execute procedure count_stages(1);
...
for each row when (now() > '2018-03-11 12:00') execute procedure count_jobs(1);
